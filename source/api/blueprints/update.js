...
module.exports = function updateOneRecord(req, res) {
    ...
    Model.findOne(
        ...
        .exec(function (err, matchingRecord) {
            ...
            sails.services.redis.del(`CACHE_LIST_ORDER_${matchingRecord.userId}_${matchingRecord.status}`);
            ...
            Model.updateOne(_.cloneDeep(criteria))
                ...
                .exec(function (err, updatedRecord) {
                    ...
                    sails.services.redis.del(`CACHE_LIST_ORDER_${updatedRecord.userId}_${updatedRecord.status}`);
                    ...
                    Model.findOne(
                        ...
                        .exec(function foundAgain(err, populatedRecord) {
                            ...
                            res.ok(Object.assign({}, populatedRecord, { access_token }));
